...
func NewReaderMessageProcessor(log logger.Logger, cfg *config.Config, v *validator.Validate, ps usecase.IProductUsecase, metrics *metrics.ReaderServiceMetrics) *readerMessageProcessor {
